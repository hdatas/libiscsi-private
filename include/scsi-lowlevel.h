...
enum scsi_version {
    ...
    SCSI_VERSION_SPC4 = 0x06,
    SCSI_VERSION_SPC5 = 0x07
	/*
	 * SCSI_VERSION_SPC4 = 0x06,
	 * SCSI_VERSION_SPC5 = 0x07
	 */
...
enum scsi_version_descriptor {
    ...
    SCSI_VERSION_DESCRIPTOR_SPC_4_T10_1731_D_R36		= 0x0466,
    SCSI_VERSION_DESCRIPTOR_SPC_4_T10_1731_D_R37		= 0x0468,
    SCSI_VERSION_DESCRIPTOR_SPC_4_T10_1731_D_R37a		= 0x0469,
    SCSI_VERSION_DESCRIPTOR_SPC_5               		= 0x05C0,
...
struct scsi_inquiry_standard {
	...
	int rmb;
	/*
	 * LU_CONG bit should be right after rmb in byte 1
	 * and byte 2 is version.
	 */
	int lucong;
	int version;
	int normaca;
